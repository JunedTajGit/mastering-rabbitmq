...
# (#)match one or more words in our routing key
# anything will support user.<any word or words>
channel.queue_bind(
    exchange="mytopicexchange", queue=queue.method.queue, routing_key="user.#"
)
